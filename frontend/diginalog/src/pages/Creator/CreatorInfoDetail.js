...
class CreatorInfoDetail extends Component {
  state = {
    product : null
  }
  componentDidMount() {
  ...
  componentWillReceiveProps(newProps) {
    this.getProduct(newProps['id']);
  }
  getProduct = async (id) => {
    let response = await api.get(`/api/creator/product?id=${id}`);
    console.log("id = "+id);
...
export default CreatorInfoDetail;